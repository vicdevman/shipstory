# agents/priscilla_product/agent.py
import asyncio
import logging
import os
...
async def main():
    ...
    try:
        agent_id, api_key = StateManager.load_configuration("priscilla_product")
        logger.info(f"Successfully loaded Priscilla credentials from configuration path. ID: {agent_id[:8]}...")
    ...
    logger.info("Priscilla Product Agent initialized. Establishing live connections to the Band room...")
