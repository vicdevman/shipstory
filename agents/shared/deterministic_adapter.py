...
"""
            ...
            if self.original_agent_name == "devin_eng":
                ...
                agent_instructions = (
                    ...
                    "Gigi's marketing copy drafts, and Vinci's prompt/visual mockup URL). If the user asks about what "
                    "Devin found, what Gigi wrote, or the pipeline's status, check and summarize the relevant sections of "
                    "the Active System Context. Do NOT try to delegate, query external databases, or tag other agents."
                )
